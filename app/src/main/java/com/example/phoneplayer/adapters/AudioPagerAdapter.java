...
public class AudioPagerAdapter extends BaseAdapter {
    ...
    public AudioPagerAdapter(Context context, List<MediaItem> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        VideoPagerAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            viewHolder = new VideoPagerAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.item_audio_pager, null);
